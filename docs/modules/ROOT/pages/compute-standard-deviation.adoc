...
|`<clusterName>`
|Go to *Connect Client* > *Advanced setup*. The cluster name is at the top of the list.
...
. Go to *Connect Client* > *Advanced setup*, and click *Download keystore file*.
...
. When prompted, enter the cluster name, keystore password, and discovery token for your cluster. These details are in the *Advanced setup* tab in the Hazelcast {hazelcast-cloud} console.
